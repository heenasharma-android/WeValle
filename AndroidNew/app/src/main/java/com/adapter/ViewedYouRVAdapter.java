...
public class ViewedYouRVAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
...
//                    .error(R.drawable.user_placeholder_error)
        ...
        Log.d("sumit"," vied adp= "+mDataList.get(position).getUserCity());

        holder.username.setText(mDataList.get(position).getUserName());
        holder.userAddress.setText(mDataList.get(position).getUserLocation());
