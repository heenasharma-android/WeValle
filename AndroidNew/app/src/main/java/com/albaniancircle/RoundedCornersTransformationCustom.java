...
/**
 * Created by Sumit on 07-Apr-18.
 */

public class RoundedCornersTransformationCustom implements Transformation {
    ...
    public RoundedCornersTransformationCustom(int radius, int margin) {
        this(radius, margin, CornerType.ALL);
    }

    public RoundedCornersTransformationCustom(int radius, int margin, CornerType cornerType) {
        mRadius = radius;
        mDiameter = radius * 2;
        mMargin = margin;
